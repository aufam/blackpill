##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.15.2] date: [Fri Oct 14 11:17:58 WIB 2022] 
##########################################################################################################################
...
$(PROJECT_DIR)/dsp $(PROJECT_DIR)/ambe_engine $(PROJECT_DIR)/imbe_vocoder
LDFLAGS		+= -specs=nosys.specs -lstdc++ -Wl,--print-memory-usage

CFLAGS		+= -fno-common -fmessage-length=0 -lm
CFLAGS 		+= -DUSE_PROJECT -D_USE_MATH_DEFINES
